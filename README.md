...
4.  **Syncing ADB Binaries:**
    * If you open Win2Phone and see **"ADB Status: MISSING"** in the header, click the **🔄 SYNC ADB** button.
...
2.  **Direct Execution:** If necessary, navigate directly to the WinGet folder: `cd "$env:LOCALAPPDATA\Microsoft\WinGet\Packages\Google.PlatformTools_... \platform-tools"`.
...
2.  In Win2Phone, enter the **IP:Port** and **6-Digit Code** presented on the phone into the corresponding fields.
...
2.  Verify the **Main IP** and **Main Port** in Win2Phone match your phone's current Wireless Debugging display (this port changes frequently).
